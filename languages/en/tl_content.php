 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_content']['dlh_googlemap']			= array('Google Map','Please select a Google Map.');
$GLOBALS['TL_LANG']['tl_content']['dlh_googlemap_zoom']		= array('Zoom-Factor','Here you can override the zoom factor set in the module for just this implementation.');
