 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_content']['dlh_googlemap']			= array('Google Map','Wählen Sie die gewünschte Google Map aus.');
$GLOBALS['TL_LANG']['tl_content']['dlh_googlemap_zoom']		= array('Zoom-Faktor','Hier können Sie den im Modul festgelegten Zoom-Faktor für diese Einbindung überschreiben.');
