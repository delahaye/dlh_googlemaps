...
class tl_module_dlh_googlemaps extends Backend
{
    ...
    public function mapOptions(DataContainer $dc)
    {
        ...
        while($objMaps->next())
        {
            $return[$objMaps->id] = sprintf('%s <a href="contao/main.php?do=dlh_googlemaps&act=edit&popup=1&id=%s&rt=%s"><img src="system/themes/flexible/icons/edit.svg" width="16" height="16"></a>', $objMaps->title, $objMaps->id, REQUEST_TOKEN);
        }
