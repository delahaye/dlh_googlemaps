 ...
 * Class dlhListWizard
 *
 * Provide methods to handle list items, based on Leo Feyers list wizard.
 */
class dlhListWizard extends Widget
{
...
<h2 class="sub_headline">'.$GLOBALS['TL_LANG']['tl_dlh_googlemaps_elements']['import'][1].'</h2>
'.$this->getMessages().'
...
<div class="tl_tbox block">
  ...
  <h3><label for="source">'.$GLOBALS['TL_LANG']['tl_dlh_googlemaps_elements']['importfile'][0].'</label> <a href="contao/files.php" title="' . specialchars($GLOBALS['TL_LANG']['MSC']['fileManager']) . '" rel="lightbox[files 765 80%]">' . $this->generateImage('filemanager.gif', $GLOBALS['TL_LANG']['MSC']['fileManager'], 'style="vertical-align:text-bottom;"') . '</a></h3>
'.$objTree->generate().(($GLOBALS['TL_LANG']['tl_dlh_googlemaps_elements']['importfile'][1] != '') ? '
  <p class="tl_help tl_tip">'.$GLOBALS['TL_LANG']['tl_dlh_googlemaps_elements']['importfile'][1].'</p>' : '').'
</div>
...
<div class="tl_submit_container">
  <input type="submit" name="save" id="save" class="tl_submit" accesskey="s" value="'.specialchars($GLOBALS['TL_LANG']['tl_dlh_googlemaps_elements']['import'][0]).'">
</div>
